...
mkdir -p ~/.themes/
timeout 300 curl --progress -k -L -f "https://dl.opendesktop.org/api/files/downloadfile/id/1461767736/s/b75ac7d83f1146b5efde3e9c1d66b11f/t/1531939891/u//90145-axiom.tar.gz" > /tmp/axiom.tar.gz \
